...
@shared_task
def send_email_task(subject: str, email: str, content: str) -> None:
    ...
    print("ERROR_DURING_SEND_EMAIL_TASK: Error")


@shared_task
def send_reminder_task(username: str, email: str, notebook_title: str, note_name: str, note_full_link: str) -> None:
    ...
    send_email(
        ...
        content="""
            ...
            text=_("You wanted to be reminded about {note_name}. Click on the link below in order to open it.").format(
                note_name=note_name
            ),
